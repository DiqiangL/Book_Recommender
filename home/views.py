...
def rated(userId, bookId):
    ratings = pd.read_csv("/Users/lindiqiang/Downloads/Book-recommender-system-master/Django/BookRack/home/ratings.csv", engine="python")
...
def giveRating(rating, userId, bookId):
    ...
    if not flag:
        ...
        with open("/Users/lindiqiang/Downloads/Book-recommender-system-master/Django/BookRack/home/ratings.csv", 'a+', newline='') as write_obj:
            csv_writer = writer(write_obj)
            csv_writer.writerow(row)


def recommend(bookid):
    book_description = pd.read_csv("/Users/lindiqiang/Downloads/Book-recommender-system-master/Django/BookRack/home/ratings.csv", engine="python")
...
def index(request, booktitle=None, bookauthor=None):
    if 'loginuser' in request.session:
        ...
        rbooks1 = []
        top1 = []
        mydata = pd.read_csv("/Users/lindiqiang/Downloads/Book-recommender-system-master/Django/BookRack/home/book_data2.csv", engine="python")
        top = mydata.head(20)
        ...
        if 'viewbook' in request.POST:
            ...
            book_description = pd.read_csv("/Users/lindiqiang/Downloads/Book-recommender-system-master/Django/BookRack/home/book_data2.csv", encoding='latin-1')
            books_tfidf = TfidfVectorizer(stop_words='english')
            book_description['book_desc'] = book_description['book_desc'].fillna('')
            book_description_matrix = books_tfidf.fit_transform(book_description['book_desc'])
            cosine_similarity = linear_kernel(book_description_matrix, book_description_matrix)
...
def wishlist(request):
    if 'loginuser' in request.session:
        ...
        userId = request.session["userId"]
        ratings = pd.read_csv("/Users/lindiqiang/Downloads/Book-recommender-system-master/Django/BookRack/home/ratings.csv", engine="python")
        books = pd.read_csv("/Users/lindiqiang/Downloads/Book-recommender-system-master/Django/BookRack/home/book_data2.csv", encoding='latin-1')
